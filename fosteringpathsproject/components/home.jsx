    ...
    <main className="cp-main">
      <section className="cp-hero">
        ...
        <div className="cp-cta-row">
          <button className="cp-btn" onClick={onWizard}>Find my path</button>
          <button className="cp-btn-ghost" onClick={() => document.querySelector('#careers').scrollIntoView({ behavior: 'smooth' })}>Browse all</button>
        </div>
