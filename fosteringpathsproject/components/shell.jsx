...
const CpFooter = () => (
  <footer className="cp-footer">
    <div className="cp-hdr-in">
      <div>
        <div className="cp-foot-h">Support, not a portal</div>
        <p>JBAY <a href="tel:4153480011">415-348-0011</a> · 211 any time · iFoster <a href="tel:18555213669">1-855-521-iFOS</a></p>
      </div>
      <div className="cp-foot-meta">
        <div>v1.0 · Apr 2026</div>
        <div>Written for foster youth. By nobody paid by a campus.</div>
      </div>
    </div>
  </footer>
);
...
Object.assign(window, { CpHeader, CpFooter, CpDeadlines, CpCareerRow, CpModal });
